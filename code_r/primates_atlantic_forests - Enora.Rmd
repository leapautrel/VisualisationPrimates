...
plot_a_p <- function(donnees, alti, pluvio, legende_bool = FALSE){
  ...
  if (pluvio == "Sec"){if(alti == "Plaine"){background_color = "#EDE3D8"}
    ...
    else if(alti == "Haute Montagne"){background_color = "#E0D5C7"
    }
  }
    ...
    else if(alti == "Haute Montagne"){background_color = "#E0E1DA"
    }}
  else if (pluvio == "Humide"){if(alti == "Plaine"){background_color = "#DEFAF5"}
    else if(alti == "Basse Montagne"){
    background_color = "#D9EBE8"
    }
    else if(alti == "Haute Montagne"){background_color = "#D0E0DD"
    }}
  ...
  legend = l, margin=list(l=0, r=11, t=5, b=3))
...
library(htmltools)
s <- "width: 31%;height: 9em;border: solid white; justify-content: left;padding: 0; 
   margin: 0;;justify-self: left;"
browsable(div(style = "display: flex; flex-wrap: wrap; justify-content: center;border-collapse: collapse;",
    div("Haute Montagne", style = "background: #F0F0F0; width : 3.8em; height: 9em; display: flex;border: solid white; text-align: center;font-family:Arial, Helvetica, sans-serif;font-weight:bold;letter-spacing:5px; justify-content: center;writing-mode: vertical-rl;text-orientation: mixed;transform: rotate(180deg);"),
    div(plot_s_h, style = s),
    div(plot_m_h, style = s),
    div(plot_h_h, style = s),
    div("Basse Montagne", style = "background: #F2F2F2; width : 3.8em; height: 9em; display: flex;border: solid white; text-align: center;font-family:Arial, Helvetica, sans-serif;font-weight:bold;text-align:center;letter-spacing:5px; justify-content: center;writing-mode: vertical-rl;transform: rotate(180deg);"),
    div(plot_s_b, style = s),
    div(plot_m_b, style = s),
    div(plot_h_b, style = s),
    div("Plaine", style = "background: #F5F5F5; width : 3.8em; height: 9em; display: flex;border: solid white; text-align: center;font-family:Arial, Helvetica, sans-serif;font-weight:bold;text-align:center;letter-spacing:5px; justify-content: center;writing-mode: vertical-rl;transform: rotate(180deg);"),
    div(plot_s_p, style = s),
    div(plot_m_p, style = s),
    div(plot_h_p, style = s),
    div(style = "width : 3.8em;"),
    div("Sec", style = "background: #E0D5C8; width : 31%; height: 1.8em; display: flex;border: solid white;font-family:Arial, Helvetica, sans-serif;font-weight:bold;text-align:center;letter-spacing:5px; justify-content: center;"),
    div("Moyen", style = "background: #EAEBE4; width : 31%; height: 1.8em; display: flex;border: solid white;font-family:Arial, Helvetica, sans-serif;font-weight:bold;text-align:center;letter-spacing:5px; justify-content: center;"),
    div("Humide", style = "background: #D9EBE8; width : 31%; height: 1.8em; display: flex;border: solid white;font-family:Arial, Helvetica, sans-serif;font-weight:bold;text-align:center;letter-spacing:5px; justify-content: center;")))
