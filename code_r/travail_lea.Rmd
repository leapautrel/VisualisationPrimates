...
# Tous les plots --------------------
# Pluvio = Humide
plot_h_p <- subplot(data = occ, pluvio = "Humide", alti = "Plaine")
plot_h_b <- subplot(data = occ, pluvio = "Humide", alti = "Basse Montagne")
plot_h_h <- subplot(data = occ, pluvio = "Humide", alti = "Haute Montagne")

# Pluvio = Moyen
plot_m_p <- subplot(data = occ, pluvio = "Moyen", alti = "Plaine")
plot_m_b <- subplot(data = occ, pluvio = "Moyen", alti = "Basse Montagne")
plot_m_h <- subplot(data = occ, pluvio = "Moyen", alti = "Haute Montagne")

# Pluvio = Sec
plot_s_p <- subplot(data = occ, pluvio = "Sec", alti = "Plaine")
plot_s_b <- subplot(data = occ, pluvio = "Sec", alti = "Basse Montagne")
plot_s_h <- subplot(data = occ, pluvio = "Sec", alti = "Haute Montagne")
