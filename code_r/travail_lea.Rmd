...
```{r}
# subplot -----------
subplot <- function(donnees, pluvio, alti) {
...
# Tous les plots --------------------
# Pluvio = Humide
plot_h_p <- subplot(donnees = occ, pluvio = "Humide", alti = "Plaine")
plot_h_b <- subplot(donnees = occ, pluvio = "Humide", alti = "Basse Montagne")
plot_h_h <- subplot(donnees = occ, pluvio = "Humide", alti = "Haute Montagne")

# Pluvio = Moyen
plot_m_p <- subplot(donnees = occ, pluvio = "Moyen", alti = "Plaine")
plot_m_b <- subplot(donnees = occ, pluvio = "Moyen", alti = "Basse Montagne")
plot_m_h <- subplot(donnees = occ, pluvio = "Moyen", alti = "Haute Montagne")

# Pluvio = Sec
plot_s_p <- subplot(donnees = occ, pluvio = "Sec", alti = "Plaine")
plot_s_b <- subplot(donnees = occ, pluvio = "Sec", alti = "Basse Montagne")
plot_s_h <- subplot(donnees = occ, pluvio = "Sec", alti = "Haute Montagne")
